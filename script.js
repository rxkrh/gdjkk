...
function saveRanking(time, diff) {
    ...
    const docId = `${myUid}_${diff}`;
    const docRef = db.collection('minesweeper_ranks').doc(docId);
    ...
    }).catch(err => console.error("Ranking save error:", err));
}
